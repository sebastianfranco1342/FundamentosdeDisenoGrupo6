...
- Nguyen, M., Nguyen, V. y Nguyen, H. (2023). Monitoreo basado en visualización en sistemas de alerta temprana con redes de sensores inalámbricos. Revista Indonesia de Ingeniería Eléctrica e Informática, 31(1):281-289. [(PDF) Monitorización basada en la visualización en sistemas de alerta temprana con redes inalámbricas de sensores (researchgate.net)]((PDF)-Monitorización-basada-en-la-visualización-en-sistemas-de-alerta-temprana-con-redes-inalámbricas-de-sensores-(researchgate.net))
